...
//    @GET("slae_invoice_userData.php")
    ...
    @GET("loginforsale.php")
    Call<Sale> performUserLoginSale(@Query("user_name") String UserName,@Query("password") String Password);


    @GET("sale_invoice_insert_data.php")
    Call<SaleInoviceData> insertSaleInvoice(@Query("group_name") String group_name,@Query("sale_one") String sale_one,@Query("sale_two") String sale_two,@Query("sale_three") String sale_three,@Query("sale_four") String sale_four,@Query("sale_five") String sale_five,@Query("sale_six") String sale_six,@Query("voucher_number") String voucherNumber,@Query("sdate") String saleDate,@Query("total_kyat") String totalKyat,@Query("total_pal") String totalPal,@Query("total_yae") String totalYae,@Query("qty") String qty,@Query("point_eight") String pointEight,@Query("total_ayot_kyat") String totalAyotKyat,@Query("total_ayot_pal") String totalAyotPel,@Query("total_ayot_yae") String totalAyotYae,@Query("kyat") String Kyat,@Query("pal") String Pal,@Query("yae") String Yae,@Query("gram") String Gram,@Query("cupon_code") String cuponCode,@Query("customer_id") String customerId,
    ...
    Call<OrderInoviceData> insertOrderInvoice(@Query("group_name") String group_name,@Query("sale_one") String sale_one,@Query("sale_two") String sale_two,@Query("sale_three") String sale_three,@Query("sale_four") String sale_four,@Query("sale_five") String sale_five,@Query("sale_six") String sale_six,@Query("voucher_number") String voucherNumber,@Query("order_date") String saleDate,@Query("total_kyat") String totalKyat,@Query("total_pal") String totalPal,@Query("total_yae") String totalYae,@Query("qty") String qty,@Query("point_eight") String pointEight,@Query("total_ayot_kyat") String totalAyotKyat,@Query("total_ayot_pal") String totalAyotPel,@Query("total_ayot_yae") String totalAyotYae,@Query("kyat") String Kyat,@Query("pal") String Pal,@Query("yae") String Yae,@Query("gram") String Gram,@Query("cupon_code") String cuponCode,@Query("customer_id") String customerId,
