...
public class SaleHistoryToDo implements Serializable {

    public SaleHistoryToDo(String txtDate, String txtType, String txtAmount, String cuponCode, String shopName, String phoneNumber, String dateOfBirth, String customerName, String password, String voucherNumber, String qualtity, String pointEight, String gram, String kyat, String pal, String yae,String userName) {
    ...
    public SaleHistoryToDo(String txtDate, String txtType, String txtAmount) {
        this.txtDate = txtDate;
        this.txtType = txtType;
        this.txtAmount = txtAmount;
    }
