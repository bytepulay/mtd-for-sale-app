...
import asia.nainglintun.myintthitar.activities.Fragments.SaleHome;
...
public class VoucherDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final VoucherEdit voucherEdit = new VoucherEdit();
        toolbar = findViewById(R.id.toolBar);
        toolbar.setTitle("Sale Voucher Detail");
       ...
       // linearLayoutEdit = findViewById(R.id.editVoucher);
        ...
        btnVoucherEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                toolbar.setTitle( "Sales Voucher Edit" );
               ...
               //linearLayoutEdit.setVisibility(View.VISIBLE);
                ...
                voucherEdit.setArguments(b);

                fragmentManager.beginTransaction().replace(R.id.frame_layout_sales_edit,voucherEdit).addToBackStack(null).commit();
