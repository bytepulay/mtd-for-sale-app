...
//    @GET("updatesalehistory.php")
//    Call<Salehistory> updateSaleInvoice(@Query("id") String id,@Query("sale_user_name") String sale_user_name,@Query("voucher_number") String voucherNumber,@Query("sdate") String saleDate);
