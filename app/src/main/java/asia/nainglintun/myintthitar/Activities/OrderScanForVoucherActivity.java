...
import asia.nainglintun.myintthitar.Fragments.OrderInvoiceCreate;
...
public class OrderScanForVoucherActivity extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    public void handleResult(Result rawResult) {
            ...
            public void onResponse(Call<Customer> call, Response<Customer> response) {
                if (response.body().getResponse().equals("ok")) {
                   ...
                   String customerName = response.body().getName();
                    ...
                    OrderInvoiceCreate.edCustomerName.setText(customerName);
                    OrderInvoiceCreate.edCustomerAddress.setText(address);
                    OrderInvoiceCreate.edCustomerTown.setText(town);
                    OrderInvoiceCreate.edCustomerNrc.setText(nrc);
                    OrderInvoiceCreate.edDOB.setText(dob);

                   //SaleInvoiceCreate.edCustomerNrc.setText(nrc);
                   Toast.makeText(OrderScanForVoucherActivity.this, customerId + shopName + phoneNumber + address + nrc + town + dob , Toast.LENGTH_LONG).show();
        ...
        OrderInvoiceCreate.edCustomerUserName.setText(rawResult.getText());
